...
\chapter{Desenvolvimento}
	...
	Seja como for, a álgebra no ensino fundamental, e por conseguinte no ensino superior e na carreira profissional, sobre de encadeamento fragmentado, onde a matéria é sempre estruturada encadeando-se conhecimentos anteriores para chegar na matéria corrente, sem que haja revisitação constante ou parcimônia por parte dos professores para criar maneiras de trabalhar nos alunos a revisão e o link entre as matérias.
...
\chapter{Conclusão}
	...
	Concluo dizendo que a álgebra aprendida aqui, longe dos meus longínquos 20 anos quando tive a cadeira de álgebra formal na UFF\footnote{UFF - Universidade Federal Fluminense} adquiriu outro status em minha mente. Vai valer uma pesquisa informal ao conteúdo que não está disposto na ementa da Estácio e usá-la para expandir meus estudos no sentido de aplicar novas metodologias ao ensinar o conteúdo de álgebra para o ensino fundamental.
