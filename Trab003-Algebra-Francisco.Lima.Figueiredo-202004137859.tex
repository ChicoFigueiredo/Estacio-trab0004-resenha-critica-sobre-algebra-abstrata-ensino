...
\chapter{Desenvolvimento}
	...
	Fica claro, nas conclusões de \citeaa{Bezerra2016} que 
...
\chapter{Conclusão}
	...
	\begin{figure}[h!]
		...
		\caption[Mapa mental da matemática na química]{Mapa mental da matemática na química}
		\label{fig:screenshot001}
	\end{figure}
	

	Minha conclusão é que precisamos quebrar algumas bolhas, ou espaços compartimentados, 
